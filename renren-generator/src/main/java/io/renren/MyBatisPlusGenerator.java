...
public class MyBatisPlusGenerator {
    ...
    private static DataSourceConfig initDataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/gulimall_sms?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai");
    ...
    private static PackageConfig initPackageConfig(String moduleName) {
        ...
        packageConfig.setParent("com.moudle");
